...
higherOrderSequenceApplication t r a b
  | a > b = 0
  | otherwise = foldl1 r $ map t [a..b]

sumSquares2 :: Int -> Int -> Int
sumSquares2 a b = higherOrderSequenceApplication sq (+) a b

-- Define a factorial method using the higherOrderSequenceAppliction
hoFactorial :: Int -> Int
hoFactorial a = higherOrderSequenceApplication id (*) 1 a
